...
import com.soshs.appo.restouf.entities.IndBac;
import com.soshs.appo.restouf.entities.IndBacPK;
...
public class IndBacFacadeREST extends AbstractFacade<IndBac> {
    ...
    private IndBacPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.restouf.entities.IndBacPK key = new com.soshs.appo.restouf.entities.IndBacPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.restouf.entities.IndBacPK key = getPrimaryKey(id);
