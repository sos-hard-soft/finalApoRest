...
import com.soshs.appo.restouf.entities.ResultatElpPK;
...
public class ResultatElpFacadeREST extends AbstractFacade<ResultatElp> {
    ...
    private ResultatElpPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.restouf.entities.ResultatElpPK key = new com.soshs.appo.restouf.entities.ResultatElpPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.restouf.entities.ResultatElpPK key = getPrimaryKey(id);
