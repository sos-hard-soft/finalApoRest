...
import com.soshs.appo.restouf.entities.IndContratElp;
import com.soshs.appo.restouf.entities.IndContratElpPK;
...
public class IndContratElpFacadeREST extends AbstractFacade<IndContratElp> {
    ...
    private IndContratElpPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.restouf.entities.IndContratElpPK key = new com.soshs.appo.restouf.entities.IndContratElpPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.restouf.entities.IndContratElpPK key = getPrimaryKey(id);
